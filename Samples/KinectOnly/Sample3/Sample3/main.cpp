...
int main(int argc, char **argv)
{
	...
	g_HandDetectorNite.LeftSwipePointerFunc = &pFunction1;
	g_HandDetectorNite.RightSwipePointerFunc = &pFunction2;
